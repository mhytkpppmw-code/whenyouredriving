...
Write-Utf8File "lib\submissions.ts" @'
...
Write-Utf8File "app\api\submissions\route.ts" @'
import { NextResponse } from "next/server";
import { addSubmission, readSubmissions, sanitizeInput } from "@/lib/submissions";
...
Write-Utf8File "components\lyric-builder.tsx" @'
"use client";

import { useCallback, useEffect, useState } from "react";
import { formatLyric, type Submission } from "@/lib/submissions";
